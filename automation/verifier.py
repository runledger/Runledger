...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--baseline", default=None, help="Baseline path override (optional)")
...
def main() -> None:
    ...
    cmd = ["runledger", "run", str(repo_path / args.suite_path), "--mode", "replay"]
    if args.baseline:
        cmd += ["--baseline", str(repo_path / args.baseline)]
