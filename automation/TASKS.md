...
- [x] Scaffold automation folder and config template
- [x] Implement RepoFinder (search + scoring)
- [x] Add RepoIntegrator skeleton
- [x] Add Verifier skeleton
...
- [x] Implement approval gates (target list + PR review)
- [x] Pilot on 1-2 repos and refine templates
